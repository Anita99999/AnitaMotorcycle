    ...
    private void initListener() {
        mIv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();//关闭当前activity并返回刚才跳到这里的activity(只有使用了这个方法onActivityResult才会起作用)
            }
        });
    ...
    public class MyLocationListenner extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (location.getLocType() == BDLocation.TypeGpsLocation) {// GPS定位结果
                ...
                Toast.makeText(GetLocationActivity.this, "服务器错误，请检查", Toast.LENGTH_SHORT).show();
            } else if (location.getLocType() == BDLocation.TypeNetWorkException) {//网络错误
                Toast.makeText(GetLocationActivity.this, "网络错误，请检查", Toast.LENGTH_SHORT).show();
            } else if (location.getLocType() == BDLocation.TypeCriteriaException) {//手机模式错误
                Toast.makeText(GetLocationActivity.this, "手机模式错误，请检查是否飞行", Toast.LENGTH_SHORT).show();
            }
